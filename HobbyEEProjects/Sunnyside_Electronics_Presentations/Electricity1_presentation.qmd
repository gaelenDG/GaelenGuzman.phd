...
::: incremental
-   Protons → ![](/HobbyEEProjects/Sunnyside_Electronics_Presentations/Pictures/plus-circle.svg){.absolute top="315" left="275" height="36"}
-   Electrons → ![](/HobbyEEProjects/Sunnyside_Electronics_Presentations/Pictures/minus-circle.svg){.absolute top="385" left="275" height="36"}
-   Neutrons
:::
