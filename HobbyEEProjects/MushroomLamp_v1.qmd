...
:::{.border}
![Someday I'll take a better final photo of this lamp...](/assets/images/MushroomLamp_v1/Final.png){group="MushroomLamp_v1"}
:::
...
:::{.border}
![Testing the concept of the lamp, with really basic control via the ESP32.](/assets/images/MushroomLamp_v1/Concept.png){group="MushroomLamp_v1"}
:::
...
:::{.border}
![Drying the newly-formed caulk stalks! It took a few days for them to feel solid enough to peel the plastic wrap off.](/assets/images/MushroomLamp_v1/SiliconeMolding.png){group="MushroomLamp_v1"}
:::
...
:::{.border}
![Forgive my terrible soldering, I was still learning and didn't yet have a flux pen to help guide the solder in place! I also apparently never took a picture of the top...](/assets/images/MushroomLamp_v1/PCBassembly.png){group="MushroomLamp_v1"}
:::
...
![The final product!](/assets/images/MushroomLamp_v1/Final.png){group="MushroomLamp_v1"}
