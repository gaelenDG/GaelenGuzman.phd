...
external-url: https://guzmangadissertation.netlify.app
---


<meta http-equiv="refresh" content="0;url=https://guzmangadissertation.netlify.app">

[Click here if you are not redirected!](https://guzmangadissertation.netlify.app).


```{r, include=FALSE, echo=FALSE}
## An R library that allows
library(tufte)
```

## Overview

View my dissertation in its entirety [here](https://guzmangadissertation.netlify.app){target="_blank"}.

## Chapters/Projects

### [Introduction #1 -- An accessible overview tuberculosis and lipids](https://guzmangadissertation.netlify.app/parts/introduction/intro_layperson){target="_blank"}
...
### [Introduction #2 -- TB & The Sphinx](https://guzmangadissertation.netlify.app/parts/introduction/intro_scientific){target="_blank"}
...
### [Breaking and Entering: Sphingomyelin Biosynthesis Is Essential for Phagocytic Signaling during Mycobacterium tuberculosis Host Cell Entry](){target="_blank"}
...
### [Sealing the Gaps: Sphingolipids are essential for repairing the endosomal damage caused by Mycobacterium tuberculosis](https://guzmangadissertation.netlify.app/parts/results/results_mtb_membrane_damage_v2){target="_blank"}
...
### [Living Off the Fat of the Cell: A lipidomics map of the Mycobacterium tuberculosis-infected cell](https://guzmangadissertation.netlify.app/parts/results/results_mtb_lipidomics_v2){target="_blank"}
...
### [An Affinity for Sphingolipids: Trifunctional lipid probes reveal protein-sphingolipid interactions during Mycobacterium tuberculosis infection](https://guzmangadissertation.netlify.app/parts/results/results_trifunctionalproteomics){target="_blank"}
...
### [Genetic tools to study sphingolipids in disease](https://guzmangadissertation.netlify.app/parts/addenda/addenda_sls_genetictools){target="_blank"}
...
### [The Squeaky Yeast Gets Greased: The Roles of Host Lipids in the Clearance of Pathogenic Fungi](https://guzmangadissertation.netlify.app/parts/addenda/addenda_sls_fungus){target="_blank"}
...
### [Rapid visualization and quantification of phagocytosis in neutrophils](https://guzmangadissertation.netlify.app/parts/addenda/addenda_methodsforvisualizingphagocytosis){target="_blank"}
...
### [Systematic analysis of the sphingomyelin synthase family in C. elegans](https://guzmangadissertation.netlify.app/parts/addenda/addenda_celegans_sms_family){target="_blank"}
